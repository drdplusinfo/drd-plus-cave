<?php
namespace DrdPlus\Cave\UnitBundle\Person\Races\Humans;

use DrdPlus\Cave\UnitBundle\Person\Races\Humans\Genders\CommonHumanGender;

/**
 * Class CommonHuman
 * @package DrdPlus\Cave\UnitBundle\Person\Races\Humans
 * 
