...
class LogicTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Attributes\ProfessionLevels\Exceptions\Exception
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Attributes\Exceptions\Logic
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Attributes\ProfessionLevels\Exceptions\TestLogicInterface
     */
