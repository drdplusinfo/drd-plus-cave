...
class ProfessionLevelsTest extends TestWithMockery
{
    ...
    {
        $property->shouldReceive('getName')
            ->andReturn($name);
    }
    ...
    {
        $this->askFirstLevelForPrimaryPropertiesIncrement(Priest::PRIEST, $professionLevels);
    }
    ...
    {
        $this->askFirstLevelForPrimaryPropertiesIncrement(Ranger::RANGER, $professionLevels);
    }
    ...
    {
        $this->askFirstLevelForPrimaryPropertiesIncrement(Theurgist::THEURGIST, $professionLevels);
    }
    ...
    {
        $this->askFirstLevelForPrimaryPropertiesIncrement(Thief::THIEF, $professionLevels);
    }
    ...
    {
        $this->askFirstLevelForPrimaryPropertiesIncrement(Wizard::WIZARD, $professionLevels);
    }
