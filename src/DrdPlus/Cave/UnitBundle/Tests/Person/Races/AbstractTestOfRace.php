<?php
namespace DrdPlus\Cave\UnitBundle\Tests\Person\Races;
...
abstract class AbstractTestOfRace extends TestWithMockery
{
     ...
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\UnexpectedRace
     */
     ...
     * @test
     *
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\UnexpectedSubrace
     */
