...
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGender;
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGenderWithAmbiguousGenderDetection;
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGenderWithInvalidCode;
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGenderWithoutSubraceCode;
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGenderWithUnknownGenderDetection;
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGenderWithoutFemaleDetection;
use DrdPlus\Cave\UnitBundle\Tests\Person\Races\Helpers\SubraceGenderWithoutMaleDetection;
...
class GenderTest extends TestWithMockery
{
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\GenericRaceCanNotBeCreated
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\MissingRaceCodeImplementation
     */
     ...
     * @test
     * @depends can_be_created_as_enum_type
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\MissingSubraceCodeImplementation
     */
     ...
     * @test
     * @depends can_be_created_as_enum_type
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\UnexpectedGenderCode
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\MaleDetectionNotImplemented
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\FemaleDetectionNotImplemented
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\UnknownGender
     */
    ...
    /**
     * @test
     * @expectedException \DrdPlus\Cave\UnitBundle\Person\Races\Exceptions\AmbiguousGender
     */
